...
- [ ] Add page-specific notes for `code-reference/functions-index.md` after inspecting the real project files.
- [ ] Cross-link `Functions Index` to the most relevant code, data, testing, and safety pages.
