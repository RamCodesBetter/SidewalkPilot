...
- [ ] Add page-specific notes for `code-reference/file-index.md` after inspecting the real project files.
- [ ] Cross-link `File Index` to the most relevant code, data, testing, and safety pages.
