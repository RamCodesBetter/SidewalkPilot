...
- [ ] Add page-specific notes for `safety-and-ethics/public-roads.md` after inspecting the real project files.
- [ ] Cross-link `Public Roads` to the most relevant code, data, testing, and safety pages.
