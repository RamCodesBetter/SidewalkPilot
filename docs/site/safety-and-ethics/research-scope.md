...
- [ ] Add page-specific notes for `safety-and-ethics/research-scope.md` after inspecting the real project files.
- [ ] Cross-link `Research Scope` to the most relevant code, data, testing, and safety pages.
- [ ] State the safety or ethics issue in practical project terms.
