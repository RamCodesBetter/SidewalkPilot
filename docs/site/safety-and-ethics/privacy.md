...
- [ ] Add page-specific notes for `safety-and-ethics/privacy.md` after inspecting the real project files.
- [ ] Cross-link `Privacy` to the most relevant code, data, testing, and safety pages.
