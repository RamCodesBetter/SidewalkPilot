...
- [ ] Add page-specific notes for `portfolio-evidence/demonstrations/night-failure-demo.md` after inspecting the real project files.
- [ ] Cross-link `Night Failure Demo` to the most relevant code, data, testing, and safety pages.
