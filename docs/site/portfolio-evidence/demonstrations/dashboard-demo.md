...
- [ ] Add page-specific notes for `portfolio-evidence/demonstrations/dashboard-demo.md` after inspecting the real project files.
- [ ] Cross-link `Dashboard Demo` to the most relevant code, data, testing, and safety pages.
