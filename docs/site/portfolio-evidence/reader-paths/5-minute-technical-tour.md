...
- [ ] Add page-specific notes for `portfolio-evidence/reader-paths/5-minute-technical-tour.md` after inspecting the real project files.
- [ ] Cross-link `5 Minute Technical Tour` to the most relevant code, data, testing, and safety pages.
...
- [ ] Define which readers this path serves: public visitors, builders, technical reviewers, or future collaborators.
- [ ] Keep the checklist focused on fast navigation through proof, not private notes.
