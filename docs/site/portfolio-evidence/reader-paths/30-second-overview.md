...
- [ ] Add page-specific notes for `portfolio-evidence/reader-paths/30-second-overview.md` after inspecting the real project files.
- [ ] Cross-link `30 Second Overview` to the most relevant code, data, testing, and safety pages.
