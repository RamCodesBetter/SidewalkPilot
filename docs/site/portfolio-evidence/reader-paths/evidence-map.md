...
- [ ] Add page-specific notes for `portfolio-evidence/reader-paths/evidence-map.md` after inspecting the real project files.
- [ ] Cross-link `Evidence Map` to the most relevant code, data, testing, and safety pages.
