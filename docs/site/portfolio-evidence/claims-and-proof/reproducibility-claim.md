...
- [ ] Add page-specific notes for `portfolio-evidence/claims-and-proof/reproducibility-claim.md` after inspecting the real project files.
- [ ] Cross-link `Reproducibility Claim` to the most relevant code, data, testing, and safety pages.
