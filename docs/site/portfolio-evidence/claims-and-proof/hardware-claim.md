...
- [ ] Add page-specific notes for `portfolio-evidence/claims-and-proof/hardware-claim.md` after inspecting the real project files.
- [ ] Cross-link `Hardware Claim` to the most relevant code, data, testing, and safety pages.
