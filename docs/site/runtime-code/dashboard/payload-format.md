...
- [ ] Add page-specific notes for `runtime-code/dashboard/payload-format.md` after inspecting the real project files.
- [ ] Cross-link `Payload Format` to the most relevant code, data, testing, and safety pages.
