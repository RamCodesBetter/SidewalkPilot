...
- [ ] Add page-specific notes for `runtime-code/dashboard/pages.md` after inspecting the real project files.
- [ ] Cross-link `Pages` to the most relevant code, data, testing, and safety pages.
