...
- [ ] Add page-specific notes for `runtime-code/dashboard/idle-exit.md` after inspecting the real project files.
- [ ] Cross-link `Idle Exit` to the most relevant code, data, testing, and safety pages.
