...
- [ ] Add page-specific notes for `runtime-code/dashboard/receiver.md` after inspecting the real project files.
- [ ] Cross-link `Receiver` to the most relevant code, data, testing, and safety pages.
