...
- [ ] Add page-specific notes for `runtime-code/config/dashboard-settings.md` after inspecting the real project files.
- [ ] Cross-link `Dashboard Settings` to the most relevant code, data, testing, and safety pages.
