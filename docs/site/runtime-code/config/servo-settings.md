...
- [ ] Add page-specific notes for `runtime-code/config/servo-settings.md` after inspecting the real project files.
- [ ] Cross-link `Servo Settings` to the most relevant code, data, testing, and safety pages.
