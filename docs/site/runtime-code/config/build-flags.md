...
- [ ] Add page-specific notes for `runtime-code/config/build-flags.md` after inspecting the real project files.
- [ ] Cross-link `Build Flags` to the most relevant code, data, testing, and safety pages.
