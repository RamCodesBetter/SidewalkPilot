...
- [ ] Add page-specific notes for `runtime-code/config/gpio-pins.md` after inspecting the real project files.
- [ ] Cross-link `Gpio Pins` to the most relevant code, data, testing, and safety pages.
