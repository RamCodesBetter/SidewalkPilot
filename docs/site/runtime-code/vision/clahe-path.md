...
- [ ] Add page-specific notes for `runtime-code/vision/clahe-path.md` after inspecting the real project files.
- [ ] Cross-link `CLAHE Path` to the most relevant code, data, testing, and safety pages.
