...
- [ ] Add page-specific notes for `runtime-code/vision/camera-capture.md` after inspecting the real project files.
- [ ] Cross-link `Camera Capture` to the most relevant code, data, testing, and safety pages.
