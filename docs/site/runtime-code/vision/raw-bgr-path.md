...
- [ ] Add page-specific notes for `runtime-code/vision/raw-bgr-path.md` after inspecting the real project files.
- [ ] Cross-link `Raw BGR Path` to the most relevant code, data, testing, and safety pages.
