...
- [ ] Add page-specific notes for `runtime-code/vision/model-choices.md` after inspecting the real project files.
- [ ] Cross-link `Model Choices` to the most relevant code, data, testing, and safety pages.
