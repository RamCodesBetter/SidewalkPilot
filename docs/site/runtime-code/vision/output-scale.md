...
- [ ] Add page-specific notes for `runtime-code/vision/output-scale.md` after inspecting the real project files.
- [ ] Cross-link `Output Scale` to the most relevant code, data, testing, and safety pages.
