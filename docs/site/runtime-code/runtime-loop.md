...
- [ ] Add page-specific notes for `runtime-code/runtime-loop.md` after inspecting the real project files.
- [ ] Cross-link `Runtime Loop` to the most relevant code, data, testing, and safety pages.
