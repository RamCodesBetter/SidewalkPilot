...
- [ ] Add page-specific notes for `runtime-code/hardware/cleanup.md` after inspecting the real project files.
- [ ] Cross-link `Cleanup` to the most relevant code, data, testing, and safety pages.
