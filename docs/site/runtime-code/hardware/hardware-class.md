...
- [ ] Add page-specific notes for `runtime-code/hardware/hardware-class.md` after inspecting the real project files.
- [ ] Cross-link `Hardware Class` to the most relevant code, data, testing, and safety pages.
