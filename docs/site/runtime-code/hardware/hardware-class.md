...
- Drive motors: four `PWMOutputDevice` channels are opened at 1000 Hz on the AT8236 pins: right forward/backward on GPIO 19/20 and left forward/backward on GPIO 25/13.
