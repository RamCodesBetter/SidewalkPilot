...
- [ ] Add page-specific notes for `runtime-code/hardware/hall-sensor.md` after inspecting the real project files.
- [ ] Cross-link `Hall Sensor` to the most relevant code, data, testing, and safety pages.
