...
- [ ] Add page-specific notes for `start-here/system-at-a-glance.md` after inspecting the real project files.
- [ ] Cross-link `System At A Glance` to the most relevant code, data, testing, and safety pages.
