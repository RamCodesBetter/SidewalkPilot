...
- [ ] Add page-specific notes for `start-here/build-timeline.md` after inspecting the real project files.
- [ ] Cross-link `Build Timeline` to the most relevant code, data, testing, and safety pages.
