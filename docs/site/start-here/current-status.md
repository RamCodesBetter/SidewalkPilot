...
- **Series 4:** all three temporal experiments completed 25 epochs. Six ONNX checkpoints exist and are supported by the live Jetson Orin Nano inference runtime, but none has been field-tested or promoted over v3.4.
