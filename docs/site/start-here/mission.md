...
- [ ] Add page-specific notes for `start-here/mission.md` after inspecting the real project files.
- [ ] Cross-link `Mission` to the most relevant code, data, testing, and safety pages.
