...
- [ ] Add page-specific notes for `ai-and-models/training-pipeline/sampler.md` after inspecting the real project files.
- [ ] Cross-link `Sampler` to the most relevant code, data, testing, and safety pages.
