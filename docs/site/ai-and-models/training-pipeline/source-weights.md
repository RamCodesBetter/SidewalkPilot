...
- [ ] Add page-specific notes for `ai-and-models/training-pipeline/source-weights.md` after inspecting the real project files.
- [ ] Cross-link `Source Weights` to the most relevant code, data, testing, and safety pages.
