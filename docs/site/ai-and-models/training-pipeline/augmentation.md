...
- [ ] Add page-specific notes for `ai-and-models/training-pipeline/augmentation.md` after inspecting the real project files.
- [ ] Cross-link `Augmentation` to the most relevant code, data, testing, and safety pages.
