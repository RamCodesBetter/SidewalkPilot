...
- [ ] Add page-specific notes for `ai-and-models/architecture/elu.md` after inspecting the real project files.
- [ ] Cross-link `Elu` to the most relevant code, data, testing, and safety pages.
