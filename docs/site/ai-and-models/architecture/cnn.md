...
- [ ] Add page-specific notes for `ai-and-models/architecture/cnn.md` after inspecting the real project files.
- [ ] Cross-link `CNN` to the most relevant code, data, testing, and safety pages.
