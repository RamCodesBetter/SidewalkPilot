...
- [ ] Add page-specific notes for `ai-and-models/architecture/conv-layers.md` after inspecting the real project files.
- [ ] Cross-link `Conv Layers` to the most relevant code, data, testing, and safety pages.
