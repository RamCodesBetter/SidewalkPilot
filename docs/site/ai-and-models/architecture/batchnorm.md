...
- [ ] Add page-specific notes for `ai-and-models/architecture/batchnorm.md` after inspecting the real project files.
- [ ] Cross-link `Batchnorm` to the most relevant code, data, testing, and safety pages.
