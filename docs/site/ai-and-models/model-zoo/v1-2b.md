...
- [ ] Add page-specific notes for `ai-and-models/model-zoo/v1-2b.md` after inspecting the real project files.
- [ ] Cross-link `v1.2b` to the most relevant code, data, testing, and safety pages.
