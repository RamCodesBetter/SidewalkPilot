...
| Generation | Pair | Final | Best validation | Runtime input | Training target |
|---|---|---|---|---|---|
| 4.0 | PC | `4.0p` | `4.0r` | image + previous 3 steering targets | current target |
| 4.0 | CF | `4.0f` | `4.0g` | image | current + next 3 targets |
| 4.0 | PCF | `4.0a` | `4.0c` | image + previous 3 steering targets | current + next 3 targets |
| 4.1 | PC | `4.1p` | `4.1r` | image + previous 3 steering targets | current target |
| 4.1 | CF | `4.1f` | `4.1g` | image | current + next 3 targets |
| 4.1 | PCF | `4.1a` | `4.1c` | image + previous 3 steering targets | current + next 3 targets |
...
These values come from the frozen 6,952-frame challenge set used by the all-model evaluator.
...
| Run | Change | Final | Best-validation checkpoint |
|---|---|---|---|
