...
- [ ] Add page-specific notes for `ai-and-models/model-zoo/v2-0.md` after inspecting the real project files.
- [ ] Cross-link `v2.0` to the most relevant code, data, testing, and safety pages.
