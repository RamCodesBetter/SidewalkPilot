...
- [ ] Add page-specific notes for `data-governance/data-quality/lighting-coverage.md` after inspecting the real project files.
- [ ] Cross-link `Lighting Coverage` to the most relevant code, data, testing, and safety pages.
