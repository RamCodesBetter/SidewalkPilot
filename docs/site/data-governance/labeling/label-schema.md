...
- [ ] Add page-specific notes for `data-governance/labeling/label-schema.md` after inspecting the real project files.
- [ ] Cross-link `Label Schema` to the most relevant code, data, testing, and safety pages.
