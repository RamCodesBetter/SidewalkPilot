...
- [ ] Add page-specific notes for `data-governance/labeling/duplicate-handling.md` after inspecting the real project files.
- [ ] Cross-link `Duplicate Handling` to the most relevant code, data, testing, and safety pages.
...
- [ ] Add the labeling script, tag, image count, and merge destination.
- [ ] Add review steps before labels become training data.
