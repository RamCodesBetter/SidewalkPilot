...
- [ ] Add page-specific notes for `data-governance/labeling/correction-schema.md` after inspecting the real project files.
- [ ] Cross-link `Correction Schema` to the most relevant code, data, testing, and safety pages.
