...
- [ ] Add page-specific notes for `model-evaluation/field-evaluation/smoothness.md` after inspecting the real project files.
- [ ] Cross-link `Smoothness` to the most relevant code, data, testing, and safety pages.
