...
- [ ] Add page-specific notes for `model-evaluation/offline-evaluation/within-degree-buckets.md` after inspecting the real project files.
- [ ] Cross-link `Within Degree Buckets` to the most relevant code, data, testing, and safety pages.
