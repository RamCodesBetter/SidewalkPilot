...
- [ ] Add page-specific notes for `model-evaluation/offline-evaluation/signed-error.md` after inspecting the real project files.
- [ ] Cross-link `Signed Error` to the most relevant code, data, testing, and safety pages.
