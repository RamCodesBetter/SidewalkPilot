...
- The PyTorch checkpoint and ONNX model load.
- Input names and shapes match the intended PC, CF, or PCF contract.
- Output shape and steering decoder agree.
- ONNX inference uses the expected GPU provider on Jetson Orin Nano.
...
- **Pending:** all six 4.1 checkpoints require common-set evaluation, runtime integration, and physical testing.
