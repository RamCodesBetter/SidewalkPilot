...
- [ ] Add page-specific notes for `roadmap/sensor-fusion.md` after inspecting the real project files.
- [ ] Cross-link `Sensor Fusion` to the most relevant code, data, testing, and safety pages.
