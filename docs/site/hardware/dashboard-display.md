...
- [ ] Add page-specific notes for `hardware/dashboard-display.md` after inspecting the real project files.
- [ ] Cross-link `Dashboard Display` to the most relevant code, data, testing, and safety pages.
