...
- [ ] Add page-specific notes for `hardware/power.md` after inspecting the real project files.
- [ ] Cross-link `Power` to the most relevant code, data, testing, and safety pages.
