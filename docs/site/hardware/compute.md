...
- [ ] Add page-specific notes for `hardware/compute.md` after inspecting the real project files.
- [ ] Cross-link `Compute` to the most relevant code, data, testing, and safety pages.
