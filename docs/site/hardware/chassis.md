...
- [ ] Add page-specific notes for `hardware/chassis.md` after inspecting the real project files.
- [ ] Cross-link `Chassis` to the most relevant code, data, testing, and safety pages.
