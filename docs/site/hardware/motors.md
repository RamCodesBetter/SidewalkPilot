...
- [ ] Add page-specific notes for `hardware/motors.md` after inspecting the real project files.
- [ ] Cross-link `Motors` to the most relevant code, data, testing, and safety pages.
