...
- [ ] Add page-specific notes for `hardware/wiring/i2c.md` after inspecting the real project files.
- [ ] Cross-link `I2C` to the most relevant code, data, testing, and safety pages.
