...
- [ ] Add page-specific notes for `hardware/wiring/usb.md` after inspecting the real project files.
- [ ] Cross-link `USB` to the most relevant code, data, testing, and safety pages.
