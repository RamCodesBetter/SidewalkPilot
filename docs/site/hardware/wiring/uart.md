...
- [ ] Add page-specific notes for `hardware/wiring/uart.md` after inspecting the real project files.
- [ ] Cross-link `UART` to the most relevant code, data, testing, and safety pages.
