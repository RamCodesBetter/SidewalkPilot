...
- [ ] Add page-specific notes for `hardware/wiring/power-wiring.md` after inspecting the real project files.
- [ ] Cross-link `Power Wiring` to the most relevant code, data, testing, and safety pages.
