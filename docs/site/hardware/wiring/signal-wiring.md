...
- [ ] Add page-specific notes for `hardware/wiring/signal-wiring.md` after inspecting the real project files.
- [ ] Cross-link `Signal Wiring` to the most relevant code, data, testing, and safety pages.
