...
- [ ] Add page-specific notes for `runbooks/training-day/during-training.md` after inspecting the real project files.
- [ ] Cross-link `During Training` to the most relevant code, data, testing, and safety pages.
