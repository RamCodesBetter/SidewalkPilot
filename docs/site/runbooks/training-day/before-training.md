...
- [ ] Add page-specific notes for `runbooks/training-day/before-training.md` after inspecting the real project files.
- [ ] Cross-link `Before Training` to the most relevant code, data, testing, and safety pages.
