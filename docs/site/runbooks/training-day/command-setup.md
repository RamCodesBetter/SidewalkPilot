...
- [ ] Add page-specific notes for `runbooks/training-day/command-setup.md` after inspecting the real project files.
- [ ] Cross-link `Command Setup` to the most relevant code, data, testing, and safety pages.
