...
- [ ] Add page-specific notes for `runbooks/sync-day/sync-verification.md` after inspecting the real project files.
- [ ] Cross-link `Sync Verification` to the most relevant code, data, testing, and safety pages.
