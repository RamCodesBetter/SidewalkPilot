...
- [ ] Add page-specific notes for `runbooks/sync-day/delete-risk.md` after inspecting the real project files.
- [ ] Cross-link `Delete Risk` to the most relevant code, data, testing, and safety pages.
