...
- [ ] Add page-specific notes for `runbooks/sync-day/mac-to-pc.md` after inspecting the real project files.
- [ ] Cross-link `Mac To Pc` to the most relevant code, data, testing, and safety pages.
