...
- [ ] Add page-specific notes for `runbooks/field-test-day/stop-procedure.md` after inspecting the real project files.
- [ ] Cross-link `Stop Procedure` to the most relevant code, data, testing, and safety pages.
