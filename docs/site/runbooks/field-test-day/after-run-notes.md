...
- [ ] Add page-specific notes for `runbooks/field-test-day/after-run-notes.md` after inspecting the real project files.
- [ ] Cross-link `After Run Notes` to the most relevant code, data, testing, and safety pages.
