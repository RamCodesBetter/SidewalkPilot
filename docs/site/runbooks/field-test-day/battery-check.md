...
- [ ] Add page-specific notes for `runbooks/field-test-day/battery-check.md` after inspecting the real project files.
- [ ] Cross-link `Battery Check` to the most relevant code, data, testing, and safety pages.
