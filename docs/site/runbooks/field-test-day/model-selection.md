...
- [ ] Add page-specific notes for `runbooks/field-test-day/model-selection.md` after inspecting the real project files.
- [ ] Cross-link `Model Selection` to the most relevant code, data, testing, and safety pages.
