...
- [ ] Add page-specific notes for `runbooks/field-test-day/sensor-check.md` after inspecting the real project files.
- [ ] Cross-link `Sensor Check` to the most relevant code, data, testing, and safety pages.
