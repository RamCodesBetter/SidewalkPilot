...
- [ ] Add page-specific notes for `research-and-math/machine-learning/overfitting-risk.md` after inspecting the real project files.
- [ ] Cross-link `Overfitting Risk` to the most relevant code, data, testing, and safety pages.
