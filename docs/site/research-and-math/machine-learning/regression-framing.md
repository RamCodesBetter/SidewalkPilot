...
- [ ] Add page-specific notes for `research-and-math/machine-learning/regression-framing.md` after inspecting the real project files.
- [ ] Cross-link `Regression Framing` to the most relevant code, data, testing, and safety pages.
