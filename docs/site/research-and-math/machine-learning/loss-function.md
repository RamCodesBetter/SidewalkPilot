...
- [ ] Add page-specific notes for `research-and-math/machine-learning/loss-function.md` after inspecting the real project files.
- [ ] Cross-link `Loss Function` to the most relevant code, data, testing, and safety pages.
