...
- [ ] Add page-specific notes for `research-and-math/machine-learning/sim-to-real-gap.md` after inspecting the real project files.
- [ ] Cross-link `Sim To Real Gap` to the most relevant code, data, testing, and safety pages.
