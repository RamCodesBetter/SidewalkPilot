...
- [ ] Add page-specific notes for `research-and-math/geometry/haversine-distance.md` after inspecting the real project files.
- [ ] Cross-link `Haversine Distance` to the most relevant code, data, testing, and safety pages.
