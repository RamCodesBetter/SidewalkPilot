...
- [ ] Add page-specific notes for `research-and-math/geometry/bearing.md` after inspecting the real project files.
- [ ] Cross-link `Bearing` to the most relevant code, data, testing, and safety pages.
