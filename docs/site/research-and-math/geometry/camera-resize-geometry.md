...
- [ ] Add page-specific notes for `research-and-math/geometry/camera-resize-geometry.md` after inspecting the real project files.
- [ ] Cross-link `Camera Resize Geometry` to the most relevant code, data, testing, and safety pages.
