...
- [ ] Add page-specific notes for `research-and-math/geometry/turn-angle.md` after inspecting the real project files.
- [ ] Cross-link `Turn Angle` to the most relevant code, data, testing, and safety pages.
