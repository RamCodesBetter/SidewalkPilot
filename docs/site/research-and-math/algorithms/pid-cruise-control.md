...
- [ ] Add page-specific notes for `research-and-math/algorithms/pid-cruise-control.md` after inspecting the real project files.
- [ ] Cross-link `PID Cruise Control` to the most relevant code, data, testing, and safety pages.
