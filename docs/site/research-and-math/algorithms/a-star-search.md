...
- [ ] Add page-specific notes for `research-and-math/algorithms/a-star-search.md` after inspecting the real project files.
- [ ] Cross-link `A Star Search` to the most relevant code, data, testing, and safety pages.
