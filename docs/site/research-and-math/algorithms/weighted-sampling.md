...
- [ ] Add page-specific notes for `research-and-math/algorithms/weighted-sampling.md` after inspecting the real project files.
- [ ] Cross-link `Weighted Sampling` to the most relevant code, data, testing, and safety pages.
