...
- [ ] Add page-specific notes for `research-and-math/algorithms/speed-from-hall-pulses.md` after inspecting the real project files.
- [ ] Cross-link `Speed From Hall Pulses` to the most relevant code, data, testing, and safety pages.
