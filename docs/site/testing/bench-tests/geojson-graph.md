...
- [ ] Add page-specific notes for `testing/bench-tests/geojson-graph.md` after inspecting the real project files.
- [ ] Cross-link `Geojson Graph` to the most relevant code, data, testing, and safety pages.
