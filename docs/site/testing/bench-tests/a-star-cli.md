...
- [ ] Add page-specific notes for `testing/bench-tests/a-star-cli.md` after inspecting the real project files.
- [ ] Cross-link `A Star Cli` to the most relevant code, data, testing, and safety pages.
