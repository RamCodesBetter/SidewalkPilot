...
- [ ] Add page-specific notes for `testing/bench-tests/lidar-viewer.md` after inspecting the real project files.
- [ ] Cross-link `LiDAR Viewer` to the most relevant code, data, testing, and safety pages.
