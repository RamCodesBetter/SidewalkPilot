...
- [ ] Add page-specific notes for `testing/field-testing/manual-takeovers.md` after inspecting the real project files.
- [ ] Cross-link `Manual Takeovers` to the most relevant code, data, testing, and safety pages.
