...
- [ ] Add page-specific notes for `testing/field-testing/preflight-checklist.md` after inspecting the real project files.
- [ ] Cross-link `Preflight Checklist` to the most relevant code, data, testing, and safety pages.
