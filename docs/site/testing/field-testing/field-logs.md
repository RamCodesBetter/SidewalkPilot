...
- [ ] Add page-specific notes for `testing/field-testing/field-logs.md` after inspecting the real project files.
- [ ] Cross-link `Field Logs` to the most relevant code, data, testing, and safety pages.
