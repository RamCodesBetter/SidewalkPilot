...
- [ ] Add page-specific notes for `testing/failures/evening-failures.md` after inspecting the real project files.
- [ ] Cross-link `Evening Failures` to the most relevant code, data, testing, and safety pages.
