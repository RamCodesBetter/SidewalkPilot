...
- [ ] Add page-specific notes for `testing/failures/shadow-failures.md` after inspecting the real project files.
- [ ] Cross-link `Shadow Failures` to the most relevant code, data, testing, and safety pages.
