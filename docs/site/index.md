...
- [Offline model evaluation](model-evaluation/offline-evaluation/overview.md) compares all 52 Series 1-4.1 checkpoints on the same frozen 6,952-frame challenge set from the 81,237-image Series 3/4 dataset.
