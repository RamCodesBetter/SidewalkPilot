...
- [ ] Add page-specific notes for `safety-case/operating-limits/where-it-cannot-run.md` after inspecting the real project files.
- [ ] Cross-link `Where It Cannot Run` to the most relevant code, data, testing, and safety pages.
