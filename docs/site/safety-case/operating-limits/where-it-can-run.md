...
- [ ] Add page-specific notes for `safety-case/operating-limits/where-it-can-run.md` after inspecting the real project files.
- [ ] Cross-link `Where It Can Run` to the most relevant code, data, testing, and safety pages.
