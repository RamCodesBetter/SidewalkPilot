...
- [ ] Add page-specific notes for `safety-case/hazard-analysis/road-entry.md` after inspecting the real project files.
- [ ] Cross-link `Road Entry` to the most relevant code, data, testing, and safety pages.
