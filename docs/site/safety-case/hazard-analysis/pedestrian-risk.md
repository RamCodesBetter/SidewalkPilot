...
- [ ] Add page-specific notes for `safety-case/hazard-analysis/pedestrian-risk.md` after inspecting the real project files.
- [ ] Cross-link `Pedestrian Risk` to the most relevant code, data, testing, and safety pages.
