...
- [ ] Add page-specific notes for `safety-case/hazard-analysis/sensor-disconnect-risk.md` after inspecting the real project files.
- [ ] Cross-link `Sensor Disconnect Risk` to the most relevant code, data, testing, and safety pages.
