...
- [ ] Add page-specific notes for `safety-case/hazard-analysis/crosswalk-risk.md` after inspecting the real project files.
- [ ] Cross-link `Crosswalk Risk` to the most relevant code, data, testing, and safety pages.
