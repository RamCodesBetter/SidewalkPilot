...
- [ ] Add page-specific notes for `safety-case/fault-handling/manual-override.md` after inspecting the real project files.
- [ ] Cross-link `Manual Override` to the most relevant code, data, testing, and safety pages.
