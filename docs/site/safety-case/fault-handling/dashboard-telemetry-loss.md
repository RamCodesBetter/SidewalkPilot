...
- [ ] Add page-specific notes for `safety-case/fault-handling/dashboard-telemetry-loss.md` after inspecting the real project files.
- [ ] Cross-link `Dashboard Telemetry Loss` to the most relevant code, data, testing, and safety pages.
