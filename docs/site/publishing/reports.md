...
- [ ] Add page-specific notes for `publishing/reports.md` after inspecting the real project files.
- [ ] Cross-link `Reports` to the most relevant code, data, testing, and safety pages.
