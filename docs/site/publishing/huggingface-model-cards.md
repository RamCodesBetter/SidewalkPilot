...
Each model is published in its own repository:
...
- v3.4: field tested; passed every presented shadow case and tested normal left/right turns; current production choice.
