...
- [ ] Add page-specific notes for `autonomy-stack/lidar-safety/packet-parsing.md` after inspecting the real project files.
- [ ] Cross-link `Packet Parsing` to the most relevant code, data, testing, and safety pages.
