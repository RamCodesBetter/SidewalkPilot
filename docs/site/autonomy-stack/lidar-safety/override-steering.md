...
- [ ] Add page-specific notes for `autonomy-stack/lidar-safety/override-steering.md` after inspecting the real project files.
- [ ] Cross-link `Override Steering` to the most relevant code, data, testing, and safety pages.
