...
- [ ] Add page-specific notes for `autonomy-stack/camera-steering/series-differences.md` after inspecting the real project files.
- [ ] Cross-link `Series Differences` to the most relevant code, data, testing, and safety pages.
