...
- [ ] Add page-specific notes for `autonomy-stack/camera-steering/servo-output.md` after inspecting the real project files.
- [ ] Cross-link `Servo Output` to the most relevant code, data, testing, and safety pages.
