...
- [ ] Add page-specific notes for `autonomy-stack/camera-steering/frame-capture.md` after inspecting the real project files.
- [ ] Cross-link `Frame Capture` to the most relevant code, data, testing, and safety pages.
