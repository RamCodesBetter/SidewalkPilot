...
- [ ] Add page-specific notes for `autonomy-stack/camera-steering/preprocessing.md` after inspecting the real project files.
- [ ] Cross-link `Preprocessing` to the most relevant code, data, testing, and safety pages.
