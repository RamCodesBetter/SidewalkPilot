...
- [ ] Add page-specific notes for `autonomy-stack/navigation/ai-manual-segments.md` after inspecting the real project files.
- [ ] Cross-link `AI Manual Segments` to the most relevant code, data, testing, and safety pages.
