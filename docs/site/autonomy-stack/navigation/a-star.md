...
- [ ] Add page-specific notes for `autonomy-stack/navigation/a-star.md` after inspecting the real project files.
- [ ] Cross-link `A Star` to the most relevant code, data, testing, and safety pages.
