...
- [ ] Add page-specific notes for `autonomy-stack/navigation/graph-format.md` after inspecting the real project files.
- [ ] Cross-link `Graph Format` to the most relevant code, data, testing, and safety pages.
