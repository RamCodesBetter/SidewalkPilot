...
- [ ] Add page-specific notes for `autonomy-stack/navigation/resume-radius.md` after inspecting the real project files.
- [ ] Cross-link `Resume Radius` to the most relevant code, data, testing, and safety pages.
