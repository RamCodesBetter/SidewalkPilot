...
- [ ] Add page-specific notes for `autonomy-stack/navigation/turn-penalties.md` after inspecting the real project files.
- [ ] Cross-link `Turn Penalties` to the most relevant code, data, testing, and safety pages.
