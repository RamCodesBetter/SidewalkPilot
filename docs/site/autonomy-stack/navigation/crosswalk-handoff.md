...
- [ ] Add page-specific notes for `autonomy-stack/navigation/crosswalk-handoff.md` after inspecting the real project files.
- [ ] Cross-link `Crosswalk Handoff` to the most relevant code, data, testing, and safety pages.
