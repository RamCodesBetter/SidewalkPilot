...
- [ ] Add page-specific notes for `autonomy-stack/architecture/decision-priority.md` after inspecting the real project files.
- [ ] Cross-link `Decision Priority` to the most relevant code, data, testing, and safety pages.
