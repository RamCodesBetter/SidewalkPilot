...
- [ ] Add page-specific notes for `engineering-process/requirements/goals.md` after inspecting the real project files.
- [ ] Cross-link `Goals` to the most relevant code, data, testing, and safety pages.
