...
- [ ] Add page-specific notes for `engineering-process/design-decisions/b-checkpoints.md` after inspecting the real project files.
- [ ] Cross-link `B Checkpoints` to the most relevant code, data, testing, and safety pages.
