...
- [ ] Add page-specific notes for `engineering-process/design-decisions/dashboard-udp-telemetry.md` after inspecting the real project files.
- [ ] Cross-link `Dashboard UDP Telemetry` to the most relevant code, data, testing, and safety pages.
