...
- [ ] Add page-specific notes for `engineering-process/design-decisions/carla-weighting.md` after inspecting the real project files.
- [ ] Cross-link `Carla Weighting` to the most relevant code, data, testing, and safety pages.
