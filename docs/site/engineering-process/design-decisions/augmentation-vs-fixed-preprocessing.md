...
- [ ] Add page-specific notes for `engineering-process/design-decisions/augmentation-vs-fixed-preprocessing.md` after inspecting the real project files.
- [ ] Cross-link `Augmentation Vs Fixed Preprocessing` to the most relevant code, data, testing, and safety pages.
