...
- [ ] Add page-specific notes for `engineering-process/design-decisions/manual-crosswalk-handoff.md` after inspecting the real project files.
- [ ] Cross-link `Manual Crosswalk Handoff` to the most relevant code, data, testing, and safety pages.
