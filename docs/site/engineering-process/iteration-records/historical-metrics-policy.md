...
- [ ] Add page-specific notes for `engineering-process/iteration-records/historical-metrics-policy.md` after inspecting the real project files.
- [ ] Cross-link `Historical Metrics Policy` to the most relevant code, data, testing, and safety pages.
