...
- [ ] Add page-specific notes for `operations/zero-2w-dashboard.md` after inspecting the real project files.
- [ ] Cross-link `Zero 2W Dashboard` to the most relevant code, data, testing, and safety pages.
