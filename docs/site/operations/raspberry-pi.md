...
- [ ] Add page-specific notes for `operations/raspberry-pi.md` after inspecting the real project files.
- [ ] Cross-link `Raspberry Pi` to the most relevant code, data, testing, and safety pages.
