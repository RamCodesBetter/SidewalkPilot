...
- [ ] Add page-specific notes for `operations/troubleshooting.md` after inspecting the real project files.
- [ ] Cross-link `Troubleshooting` to the most relevant code, data, testing, and safety pages.
