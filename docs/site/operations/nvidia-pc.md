...
- [ ] Add page-specific notes for `operations/nvidia-pc.md` after inspecting the real project files.
- [ ] Cross-link `Nvidia Pc` to the most relevant code, data, testing, and safety pages.
