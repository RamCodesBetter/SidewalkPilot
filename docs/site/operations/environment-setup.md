...
- [ ] Add page-specific notes for `operations/environment-setup.md` after inspecting the real project files.
- [ ] Cross-link `Environment Setup` to the most relevant code, data, testing, and safety pages.
