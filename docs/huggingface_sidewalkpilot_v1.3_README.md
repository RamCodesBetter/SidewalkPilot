...
SidewalkPilot-v1.3 is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.3.pth`
- **Checkpoint created:** 2026-04-26 05:40 PM America/Los_Angeles
...
- Tuned steering smoothness/aggression while keeping the score near the v1.2 range.
- Maintained usable within-5 and within-10 counts on the same progressive evaluation table.
- Served as the first explicit smoothness/aggression experiment after the v1.2 early field-behavior run.

## Specific Issues Observed / Remaining

- Overall score and MAE did not beat v1.2 final.
- Driveway MAE stayed high at `74.95`.
- Smoothness tuning did not fix the driveway-cut recognition problem.
...
| `4` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `5` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `6` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `7` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-26 05:40 PM America/Los_Angeles
- **Full score:** `93.502%`
- **MAE:** `11.697` servo degrees
- **Median AE:** `1.765` servo degrees
- **Rank in this card:** `3` of `7` checkpoints
