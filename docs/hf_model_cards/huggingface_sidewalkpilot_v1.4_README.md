...
SidewalkPilot-v1.4 is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.4.pth`
- **Checkpoint created:** 2026-04-26 08:36 PM America/Los_Angeles
...
- Targeted curves and sloped-shadow failures from `photo_20260426`.
- D26 curves/shadows MAE dropped sharply to `3.66`.
- Raised full-set score to `94.079%` while keeping the raw-BGR Series 1 path.

## Specific Issues Observed / Remaining

- Curved curb and driveway issues remained large after the D26-specific fix.
- Hard-right/curb-smoothness subset stayed weak at `24.32` MAE.
- The model specialized toward curves/shadows more than driveway or curb-edge failures.
...
| `2` | `1.2` | `SidewalkPilot-v1.2.pth` | `93.634%` | `11.459` | `1.018` | `140.617` | `843 / 1287` | `945 / 1287` | `-5.314` |
| `3` | `1.2b` | `SidewalkPilot-v1.2b.pth` | `93.585%` | `11.548` | `1.281` | `140.920` | `849 / 1287` | `948 / 1287` | `-5.296` |
| `4` | `1.3` | `SidewalkPilot-v1.3.pth` | `93.502%` | `11.697` | `1.765` | `148.944` | `845 / 1287` | `955 / 1287` | `-5.557` |
| `5` | `1.3b` | `SidewalkPilot-v1.3b.pth` | `93.223%` | `12.199` | `3.005` | `140.762` | `823 / 1287` | `961 / 1287` | `-5.423` |
| `6` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `7` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `8` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `9` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-26 08:36 PM America/Los_Angeles
- **Full score:** `94.079%`
- **MAE:** `10.657` servo degrees
- **Median AE:** `2.194` servo degrees
- **Rank in this card:** `1` of `9` checkpoints
