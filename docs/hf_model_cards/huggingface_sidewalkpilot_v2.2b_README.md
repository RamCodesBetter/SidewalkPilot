...
SidewalkPilot-v2.2b is the best-checkpoint variant of SidewalkPilot-v2.2. It is the strongest offline checkpoint in the v2.2 family on the cleaned label set.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v2.2b.pth`
- **Checkpoint created:** 2026-05-09 05:38 PM America/Los_Angeles
...
- Saved the best checkpoint from the v2.2 relabel/augmentation training run.
- Used the relabeled D0328 and D0329 First Dataset images in the active correction set.
- Became the best offline Series 2 checkpoint before v2.3: `4.203` MAE on the current `1,464`-label evaluation.
- Kept raw-BGR inference rather than the legacy v2.0 HSV/CLAHE runtime path.

## Specific Issues Observed / Remaining

- Field testing failed because the car entered grass after about `5` seconds.
- Horizontal flip augmentation likely taught unrealistic left/right geometry for the real RC car setup.
- The offline advantage over v2.2 did not transfer into a safer field outcome.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| `1` | `2.2b` | `SidewalkPilot-v2.2b.pth` | `97.665%` | `4.203` | `3.240` | `41.550` | `1000 / 1464` | `1343 / 1464` | `0.083` |
| `2` | `2.2` | `SidewalkPilot-v2.2.pth` | `97.654%` | `4.223` | `3.304` | `35.452` | `984 / 1464` | `1350 / 1464` | `0.250` |
| `3` | `2.0` | `SidewalkPilot-v2.0.pth` | `93.727%` | `11.292` | `4.931` | `149.967` | `741 / 1464` | `938 / 1464` | `-2.598` |
| `4` | `2.0b` | `SidewalkPilot-v2.0b.pth` | `93.712%` | `11.318` | `4.990` | `149.489` | `735 / 1464` | `932 / 1464` | `-2.565` |
| `5` | `2.1b` | `SidewalkPilot-v2.1b.pth` | `93.564%` | `11.585` | `5.425` | `155.585` | `657 / 1464` | `954 / 1464` | `-0.988` |
| `6` | `2.1` | `SidewalkPilot-v2.1.pth` | `93.523%` | `11.659` | `5.392` | `156.367` | `660 / 1464` | `953 / 1464` | `-0.984` |
...
- **Checkpoint created:** 2026-05-09 05:38 PM America/Los_Angeles
- **Full score:** `97.665%`
- **MAE:** `4.203` servo degrees
- **Median AE:** `3.240` servo degrees
- **Rank in this card:** `1` of `6` listed checkpoints
...
SidewalkPilot-v2.2b can fail when lighting, sidewalk shape, camera angle, shadows, driveway cuts, curved curbs, grass edges, or evening conditions differ from the training data.
