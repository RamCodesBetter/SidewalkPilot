...
SidewalkPilot-v2.1b is the best-checkpoint variant of SidewalkPilot-v2.1. It predicts a steering servo angle from `0` to `180` degrees and uses the raw-BGR Series 2 runtime path.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v2.1b.pth`
- **Checkpoint created:** 2026-05-08 08:09 PM America/Los_Angeles
...
- Saved the best checkpoint from the v2.1 raw-BGR training run.
- Kept the newer Series 2 raw-BGR runtime path instead of the v2.0 HSV/CLAHE path.
- Slightly improved v2.1 final offline on the cleaned label set.
- Served as the strongest v2.1 checkpoint for comparison against v1.9/v1.9b and v2.2.

## Specific Issues Observed / Remaining

- Did not beat the later v2.2 checkpoints offline.
- Offline metrics did not capture the full field behavior difference against v1.9/v1.9b and v2.0/v2.0b.
- Trained before the final D0328/D0329 relabel cleanup used for the later v2.2 work.
...
| `3` | `2.1b` | `SidewalkPilot-v2.1b.pth` | `93.564%` | `11.585` | `5.425` | `155.585` | `657 / 1464` | `954 / 1464` | `-0.988` |
| `4` | `2.1` | `SidewalkPilot-v2.1.pth` | `93.523%` | `11.659` | `5.392` | `156.367` | `660 / 1464` | `953 / 1464` | `-0.984` |
...
- **Checkpoint created:** 2026-05-08 08:09 PM America/Los_Angeles
- **Full score:** `93.564%`
- **MAE:** `11.585` servo degrees
- **Median AE:** `5.425` servo degrees
- **Rank in this card:** `3` of `4` listed checkpoints
...
SidewalkPilot-v2.1b can fail when lighting, sidewalk shape, camera angle, shadows, driveway cuts, curved curbs, grass edges, or evening conditions differ from the training data.
