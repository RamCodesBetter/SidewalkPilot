...
SidewalkPilot-v1.2 is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.2.pth`
- **Checkpoint created:** 2026-04-26 12:29 AM America/Los_Angeles
...
- Improved full-set score to `93.634%` and MAE to `11.459` degrees.
- Lowered median AE to `1.018` degrees, making many straight/normal cases very close.
- Improved the hard-right/curb-smoothness subset to `22.74` MAE.

## Specific Issues Observed / Remaining

- Driveway behavior remained weak at `64.48` MAE.
- Older field-failure subsets still had large errors even though the median error was low.
- The checkpoint looked better on normal frames than on driveway-transition frames.
...
| `2` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `3` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `4` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `5` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-26 12:29 AM America/Los_Angeles
- **Full score:** `93.634%`
- **MAE:** `11.459` servo degrees
- **Median AE:** `1.018` servo degrees
- **Rank in this card:** `1` of `5` checkpoints
