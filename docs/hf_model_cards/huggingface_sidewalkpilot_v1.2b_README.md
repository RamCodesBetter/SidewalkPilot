...
SidewalkPilot-v1.2b is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.2b.pth`
- **Checkpoint created:** 2026-04-25 11:38 PM America/Los_Angeles
...
- Saved the best checkpoint from the same v1.2 training run.
- Kept v1.2-style close steering behavior, including the strong low median-error pattern.
- Provided a same-run comparison against v1.2 final for the early field-behavior checkpoint family.

## Specific Issues Observed / Remaining

- Slightly lower score and higher MAE than v1.2 final.
- Driveway and hard-right/curb-smoothness cases were not solved by best-checkpoint selection.
- The best checkpoint did not change the main v1.2 weakness: driveway transition geometry.
...
| `3` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `4` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `5` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `6` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-25 11:38 PM America/Los_Angeles
- **Full score:** `93.585%`
- **MAE:** `11.548` servo degrees
- **Median AE:** `1.281` servo degrees
- **Rank in this card:** `2` of `6` checkpoints
