...
SidewalkPilot-v1.4b is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.4b.pth`
- **Checkpoint created:** 2026-04-26 07:54 PM America/Los_Angeles
...
- Saved the best checkpoint from the curves/shadows training run.
- Kept the D26 curves/shadows improvement direction from `photo_20260426`.
- Stayed much better than early v1.0-v1.3 checkpoints on the targeted D26-style frames.

## Specific Issues Observed / Remaining

- Lower full-set score than v1.4 final.
- Not the best field-use choice compared with v1.4 final because it did not improve the key full-set metrics.
- Did not address the still-large driveway and hard-right/curb-smoothness errors.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| `1` | `1.4` | `SidewalkPilot-v1.4.pth` | `94.079%` | `10.657` | `2.194` | `132.078` | `899 / 1287` | `1008 / 1287` | `-4.997` |
| `2` | `1.4b` | `SidewalkPilot-v1.4b.pth` | `93.840%` | `11.087` | `2.960` | `131.227` | `845 / 1287` | `1012 / 1287` | `-5.101` |
| `3` | `1.2` | `SidewalkPilot-v1.2.pth` | `93.634%` | `11.459` | `1.018` | `140.617` | `843 / 1287` | `945 / 1287` | `-5.314` |
| `4` | `1.2b` | `SidewalkPilot-v1.2b.pth` | `93.585%` | `11.548` | `1.281` | `140.920` | `849 / 1287` | `948 / 1287` | `-5.296` |
| `5` | `1.3` | `SidewalkPilot-v1.3.pth` | `93.502%` | `11.697` | `1.765` | `148.944` | `845 / 1287` | `955 / 1287` | `-5.557` |
| `6` | `1.3b` | `SidewalkPilot-v1.3b.pth` | `93.223%` | `12.199` | `3.005` | `140.762` | `823 / 1287` | `961 / 1287` | `-5.423` |
| `7` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `8` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `9` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `10` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-26 07:54 PM America/Los_Angeles
- **Full score:** `93.840%`
- **MAE:** `11.087` servo degrees
- **Median AE:** `2.960` servo degrees
- **Rank in this card:** `2` of `10` checkpoints
