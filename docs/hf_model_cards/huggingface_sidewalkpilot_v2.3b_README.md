...
SidewalkPilot-v2.3b is the best-checkpoint variant of SidewalkPilot-v2.3. It predicts a steering servo angle from `0` to `180` degrees and was trained after removing horizontal flip augmentation from the v2.2 training direction.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v2.3b.pth`
...
- Saved the best checkpoint from the v2.3 no-flip training run.
- Kept the raw-BGR Series 2 inference path instead of the legacy v2.0 CLAHE path.
- Reached `2.822` MAE on the `1,464`-label evaluation set used before the D0510 field-run merge.
...
| `2.3b` | Best checkpoint from v2.3 training | same v2.3 training run | second-best offline before D0510 merge; same field failure categories observed |
...
| `2.3b` | `SidewalkPilot-v2.3b.pth` | `98.432%` | `2.822` | `1.965` | `24.829` | `0.504` | `739 / 1464` | `1188 / 1464` | `1434 / 1464` | `1460 / 1464` |
...
| `2.3b` | `5.000` | `175.000` | `96.806` | `92.082` | `45.212` | `80.994` | `103.904` | `174.836` |
...
| `2` | `2.3b` | `SidewalkPilot-v2.3b.pth` | `98.432%` | `2.822` | `1.965` | `24.829` | `1188 / 1464` | `1434 / 1464` | `0.504` |
| `3` | `2.2b` | `SidewalkPilot-v2.2b.pth` | `97.665%` | `4.203` | `3.240` | `41.550` | `1000 / 1464` | `1343 / 1464` | `0.083` |
| `4` | `2.2` | `SidewalkPilot-v2.2.pth` | `97.654%` | `4.223` | `3.304` | `35.452` | `984 / 1464` | `1350 / 1464` | `0.250` |
| `5` | `2.0` | `SidewalkPilot-v2.0.pth` | `93.727%` | `11.292` | `4.931` | `149.967` | `741 / 1464` | `938 / 1464` | `-2.598` |
| `6` | `2.0b` | `SidewalkPilot-v2.0b.pth` | `93.712%` | `11.318` | `4.990` | `149.489` | `735 / 1464` | `932 / 1464` | `-2.565` |
| `7` | `2.1b` | `SidewalkPilot-v2.1b.pth` | `93.564%` | `11.585` | `5.425` | `155.585` | `657 / 1464` | `954 / 1464` | `-0.988` |
| `8` | `2.1` | `SidewalkPilot-v2.1.pth` | `93.523%` | `11.659` | `5.392` | `156.367` | `660 / 1464` | `953 / 1464` | `-0.984` |
...
| `2.3b` | `2.454` | `2.569` | `3.409` | `3.149` | `3.425` | `2.516` | `3.460` | `3.227` | `2.496` | `4.004` |
...
- **Checkpoint created:** 2026-05-09 08:50 PM America/Los_Angeles
- **Full score:** `98.432%`
- **MAE:** `2.822` servo degrees
- **Median AE:** `1.965` servo degrees
- **Rank in this card:** `2` of `8` listed checkpoints
...
SidewalkPilot-v2.3b can fail when lighting, sidewalk shape, camera angle, shadows, driveway cuts, curved curbs, grass edges, road-edge position, or evening conditions differ from the training data.
