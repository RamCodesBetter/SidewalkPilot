...
SidewalkPilot-v1.7 is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.7.pth`
- **Checkpoint created:** 2026-04-29 09:11 PM America/Los_Angeles
...
- Targeted driveway and shadow field failures from `photo_20260429`.
- D29 driveway/shadow MAE dropped to `0.93`.
- Improved full-set score to `94.956%`.

## Specific Issues Observed / Remaining

- The later `photo_20260502_12` shadow set was still weak at `17.51` MAE.
- Hard-right/curb-smoothness remained around `22.41` MAE.
- The checkpoint fixed driveway/shadow cases but did not solve the later low-sun shadow or right-hard-turn sets.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| `1` | `1.7` | `SidewalkPilot-v1.7.pth` | `94.956%` | `9.079` | `3.523` | `108.732` | `801 / 1287` | `1007 / 1287` | `-2.665` |
| `2` | `1.6` | `SidewalkPilot-v1.6.pth` | `94.540%` | `9.828` | `3.953` | `131.186` | `776 / 1287` | `1013 / 1287` | `-2.877` |
| `3` | `1.6b` | `SidewalkPilot-v1.6b.pth` | `94.522%` | `9.860` | `3.848` | `130.713` | `774 / 1287` | `1006 / 1287` | `-3.025` |
| `4` | `1.5` | `SidewalkPilot-v1.5.pth` | `94.337%` | `10.193` | `3.711` | `112.289` | `766 / 1287` | `1011 / 1287` | `-3.734` |
| `5` | `1.5b` | `SidewalkPilot-v1.5b.pth` | `94.337%` | `10.193` | `3.711` | `112.289` | `766 / 1287` | `1011 / 1287` | `-3.734` |
| `6` | `1.4` | `SidewalkPilot-v1.4.pth` | `94.079%` | `10.657` | `2.194` | `132.078` | `899 / 1287` | `1008 / 1287` | `-4.997` |
| `7` | `1.4b` | `SidewalkPilot-v1.4b.pth` | `93.840%` | `11.087` | `2.960` | `131.227` | `845 / 1287` | `1012 / 1287` | `-5.101` |
| `8` | `1.2` | `SidewalkPilot-v1.2.pth` | `93.634%` | `11.459` | `1.018` | `140.617` | `843 / 1287` | `945 / 1287` | `-5.314` |
| `9` | `1.2b` | `SidewalkPilot-v1.2b.pth` | `93.585%` | `11.548` | `1.281` | `140.920` | `849 / 1287` | `948 / 1287` | `-5.296` |
| `10` | `1.3` | `SidewalkPilot-v1.3.pth` | `93.502%` | `11.697` | `1.765` | `148.944` | `845 / 1287` | `955 / 1287` | `-5.557` |
| `11` | `1.3b` | `SidewalkPilot-v1.3b.pth` | `93.223%` | `12.199` | `3.005` | `140.762` | `823 / 1287` | `961 / 1287` | `-5.423` |
| `12` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `13` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `14` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `15` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
- **Checkpoint created:** 2026-04-29 09:11 PM America/Los_Angeles
- **Full score:** `94.956%`
- **MAE:** `9.079` servo degrees
- **Median AE:** `3.523` servo degrees
- **Rank in this card:** `1` of `15` checkpoints
