...
SidewalkPilot-v1.9b is a PyTorch steering model for a small autonomous RC car. It takes a full camera frame as input and predicts a steering servo angle from `0` to `180` degrees.
...
- **Library:** PyTorch
- **License:** Apache 2.0
- **Checkpoint:** `SidewalkPilot-v1.9b.pth`
- **Checkpoint created:** 2026-05-02 10:51 PM America/Los_Angeles
...
- Saved the best checkpoint from the v1.9 hard-turn/curb-smoothness run.
- Slightly better within-5 count than v1.9 final: `889` vs `886`.
- Slightly better `20260502_19` subset MAE: `2.31` vs `2.32`.

## Specific Issues Observed / Remaining

- Slightly lower full-set score and slightly higher full-set MAE than v1.9 final.
- v1.9 final remained the stronger full-set offline checkpoint, while v1.9b only had a small within-5 and hard/curb/smooth subset advantage.
- The best checkpoint did not create a clear deployment-level improvement over v1.9 final.
...
| `1.9` | Right hard turns, small curb hugging, smoother drive | `photo_20260502_19` | new offline leader |
| `1.9b` | Best checkpoint from 1.9 run | `photo_20260502_19` | near tie with 1.9 final |
...
| `1.9` | `SidewalkPilot-v1.9.pth` | `96.753%` | `5.845` | `2.601` | `94.329` | `-2.176` | `554 / 1287` | `886 / 1287` | `1096 / 1287` | `1229 / 1287` |
| `1.9b` | `SidewalkPilot-v1.9b.pth` | `96.749%` | `5.851` | `2.516` | `94.336` | `-2.157` | `563 / 1287` | `889 / 1287` | `1091 / 1287` | `1232 / 1287` |
...
| `1.9` | `4.000` | `176.000` | `94.664` | `90.169` | `38.173` | `73.304` | `114.332` | `172.109` |
| `1.9b` | `4.000` | `176.000` | `94.683` | `90.137` | `38.225` | `73.520` | `114.094` | `171.917` |

## Ranking

| Rank In This Card | Model | Checkpoint | Score | MAE | Median AE | Max AE | Within 5° | Within 10° | Signed Error |
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| `1` | `1.9` | `SidewalkPilot-v1.9.pth` | `96.753%` | `5.845` | `2.601` | `94.329` | `886 / 1287` | `1096 / 1287` | `-2.176` |
| `2` | `1.9b` | `SidewalkPilot-v1.9b.pth` | `96.749%` | `5.851` | `2.516` | `94.336` | `889 / 1287` | `1091 / 1287` | `-2.157` |
| `3` | `1.8` | `SidewalkPilot-v1.8.pth` | `95.702%` | `7.737` | `3.273` | `110.699` | `831 / 1287` | `1054 / 1287` | `-3.228` |
| `4` | `1.8b` | `SidewalkPilot-v1.8b.pth` | `95.697%` | `7.746` | `3.171` | `110.106` | `828 / 1287` | `1055 / 1287` | `-3.220` |
| `5` | `1.7b` | `SidewalkPilot-v1.7b.pth` | `94.979%` | `9.039` | `3.470` | `109.148` | `804 / 1287` | `1007 / 1287` | `-2.887` |
| `6` | `1.7` | `SidewalkPilot-v1.7.pth` | `94.956%` | `9.079` | `3.523` | `108.732` | `801 / 1287` | `1007 / 1287` | `-2.665` |
| `7` | `1.6` | `SidewalkPilot-v1.6.pth` | `94.540%` | `9.828` | `3.953` | `131.186` | `776 / 1287` | `1013 / 1287` | `-2.877` |
| `8` | `1.6b` | `SidewalkPilot-v1.6b.pth` | `94.522%` | `9.860` | `3.848` | `130.713` | `774 / 1287` | `1006 / 1287` | `-3.025` |
| `9` | `1.5` | `SidewalkPilot-v1.5.pth` | `94.337%` | `10.193` | `3.711` | `112.289` | `766 / 1287` | `1011 / 1287` | `-3.734` |
| `10` | `1.5b` | `SidewalkPilot-v1.5b.pth` | `94.337%` | `10.193` | `3.711` | `112.289` | `766 / 1287` | `1011 / 1287` | `-3.734` |
| `11` | `1.4` | `SidewalkPilot-v1.4.pth` | `94.079%` | `10.657` | `2.194` | `132.078` | `899 / 1287` | `1008 / 1287` | `-4.997` |
| `12` | `1.4b` | `SidewalkPilot-v1.4b.pth` | `93.840%` | `11.087` | `2.960` | `131.227` | `845 / 1287` | `1012 / 1287` | `-5.101` |
| `13` | `1.2` | `SidewalkPilot-v1.2.pth` | `93.634%` | `11.459` | `1.018` | `140.617` | `843 / 1287` | `945 / 1287` | `-5.314` |
| `14` | `1.2b` | `SidewalkPilot-v1.2b.pth` | `93.585%` | `11.548` | `1.281` | `140.920` | `849 / 1287` | `948 / 1287` | `-5.296` |
| `15` | `1.3` | `SidewalkPilot-v1.3.pth` | `93.502%` | `11.697` | `1.765` | `148.944` | `845 / 1287` | `955 / 1287` | `-5.557` |
| `16` | `1.3b` | `SidewalkPilot-v1.3b.pth` | `93.223%` | `12.199` | `3.005` | `140.762` | `823 / 1287` | `961 / 1287` | `-5.423` |
| `17` | `1.1` | `SidewalkPilot-v1.1.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `18` | `1.1b` | `SidewalkPilot-v1.1b.pth` | `92.372%` | `13.730` | `3.886` | `144.676` | `746 / 1287` | `916 / 1287` | `-6.197` |
| `19` | `1.0` | `SidewalkPilot-v1.0.pth` | `88.339%` | `20.990` | `9.934` | `151.830` | `423 / 1287` | `648 / 1287` | `-7.262` |
| `20` | `1.0b` | `SidewalkPilot-v1.0b.pth` | `88.292%` | `21.075` | `10.234` | `152.629` | `410 / 1287` | `640 / 1287` | `-6.691` |
...
| `1.9` | `4.61` | `1.74` | `1.92` | `1.41` | `1.32` | `2.32` |
| `1.9b` | `4.58` | `1.73` | `2.04` | `1.43` | `1.36` | `2.31` |
...
- **Checkpoint created:** 2026-05-02 10:51 PM America/Los_Angeles
- **Full score:** `96.749%`
- **MAE:** `5.851` servo degrees
- **Median AE:** `2.516` servo degrees
- **Rank in this card:** `2` of `20` checkpoints
