...
STEERING_CENTER_SETTLE_LOW_OVERSHOOT_DEG = float(
    os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_LOW_OVERSHOOT_DEG", str(STEERING_CENTER_SETTLE_OVERSHOOT_DEG))
)
STEERING_CENTER_SETTLE_HIGH_OVERSHOOT_DEG = float(
    os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_HIGH_OVERSHOOT_DEG", str(STEERING_CENTER_SETTLE_OVERSHOOT_DEG))
)
