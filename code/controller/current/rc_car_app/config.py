...
STEERING_CENTER_SETTLE_LOW_OVERSHOOT_DEG = float(
    os.environ.get(
        "RC_CAR_STEERING_CENTER_SETTLE_LOW_OVERSHOOT_DEG",
        os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_OVERSHOOT_DEG", "12.0"),
    )
)
STEERING_CENTER_SETTLE_HIGH_OVERSHOOT_DEG = float(
    os.environ.get(
        "RC_CAR_STEERING_CENTER_SETTLE_HIGH_OVERSHOOT_DEG",
        os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_OVERSHOOT_DEG", "3.0"),
    )
)
