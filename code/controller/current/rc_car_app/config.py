...
STEERING_SERVO_CENTER_OFFSET = 0.0
...
STEERING_CENTER_SETTLE_DURATION_SEC = float(os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_DURATION_SEC", "3.0"))
STEERING_CENTER_SETTLE_LOW_RELEASE_TARGET_DEG = float(
    os.environ.get(
        ...
        os.environ.get(
            ...
            str(_STEERING_CENTER_DEG + STEERING_CENTER_SETTLE_LEFT_OVERSHOOT_DEG),
        ),
    )
)
STEERING_CENTER_SETTLE_LOW_RELEASE_DURATION_SEC = float(
    os.environ.get(
        ...
        os.environ.get(
            ...
            os.environ.get("RC_CAR_STEERING_CENTER_SETTLE_DURATION_SEC", "3.0"),
        ),
    )
)
STEERING_CENTER_SETTLE_HIGH_RELEASE_TARGET_DEG = float(
    os.environ.get(
        ...
        os.environ.get(
            ...
            str(_STEERING_CENTER_DEG - STEERING_CENTER_SETTLE_HIGH_OVERSHOOT_DEG),
        ),
    )
)
