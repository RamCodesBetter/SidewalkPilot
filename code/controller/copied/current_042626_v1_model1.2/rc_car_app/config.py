...
STEERING_SERVO_CENTER_OFFSET = 0.04
...
# Use UDP over the Pi 5 <-> Zero 2 W USB Ethernet gadget by default so the
# same cable can carry Raspberry Pi Connect traffic and dashboard telemetry.
...
DEBUG_CONTROLLER_INPUTS = True
DASHBOARD_PAGE_COUNT = 5
DASHBOARD_PAGE_AXIS_THRESHOLD = 0.75
DASHBOARD_PAGE_HOLD_SEC = 0.2

CRUISE_TOGGLE_BUTTONS = (4,)
SHIFT_DOWN_BUTTON = 6
SHIFT_UP_BUTTON = 7
AUTONOMY_TOGGLE_BUTTON = 1
